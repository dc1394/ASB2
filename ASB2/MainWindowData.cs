...
namespace ASB2
{
    internal sealed class MainWindowData : INotifyPropertyChanged
    {
        #region 列挙型
        ...
        private String loopNumText = "0" + MainWindowData.LOOPTEXT;
        private String totalWriteText = MainWindowData.TOTALWRITETEXT;
        private String writeSpeedText = MainWindowData.WRITESPEEDTEXT;
        private String readSpeedText = MainWindowData.READSPEEDTEXT;
        private String averageWriteSpeedText = MainWindowData.AVERAGEWRITESPEEDTEXT;
        private String averageReadSpeedText = MainWindowData.AVERAGEREADSPEEDTEXT;
        ...
        internal MainWindowData(SaveDataManage.SaveData sd)
        {
            this.sd = sd;
